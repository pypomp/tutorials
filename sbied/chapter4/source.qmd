...
**4.** `pypomp` API for IF2: `mif(J=..., M=..., rw_sd=..., key=...)` runs IF2, `RWSigma(sigmas={...}, init_names=[...]).geometric_cooling(a=...)` specifies perturbations and their cooling, `results_history.last().traces_da` gets parameter traces.
