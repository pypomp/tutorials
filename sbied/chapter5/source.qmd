...
# backward compatibility with older pypomp results location
import pypomp.core.results
import pypomp.core.rw_sigma
sys.modules['pypomp.results'] = pypomp.core.results
sys.modules['pypomp.RWSigma_class'] = pypomp.core.rw_sigma
...
pf = london_pf
df_cll = pf.CLL() # replicate  rep  time CLL
model_cll = (df_cll
    .groupby('time')['CLL']
    .mean().
    reset_index()
