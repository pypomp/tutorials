...
#this is less complete than the following dataset 
#coord = (read_csv_from_package_pandas(
#    "pypomp", "data/uk_measles/raw/coord_urban.csv")
#    .rename(columns={"X":"unit"})
#)

# data taken from https://github.com/kingaa/sbied/blob/master/measles/data/EW_Lat_Long.csv
x = (pd.read_csv("EW_Lat_Long.csv")
