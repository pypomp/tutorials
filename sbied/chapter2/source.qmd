...
# This imports the R-SBIED version rather than the local verison.
# They should be the same, so this is just an exercise
...
```{python}
#| echo: false
#| fig-cap: "SIR simulation (red) and 1948 Consett measles data (black)"
...
The data are in black; the 20 simulations are shown in red.
