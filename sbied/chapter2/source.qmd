...
## Compartment models in `pypomp`: The Consett measles outbreak 
...
A call to `Pomp` assembles the model components together with the data:
...
Recall that $\mathcal R_0$ is the expected number of secondary infections caused by one primary infection introduced into a fully susceptible population.  
