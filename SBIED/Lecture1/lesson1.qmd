...
Basic model components are user-specified methods belonging to `pp` that perform the elementary computations that specify a POMP model. There are five of these:
