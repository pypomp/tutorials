...
The following table summarizes the main differences between `pypomp` and `pomp`, highlighting the new capabilities of `pypomp`. 
...
Table @tbl:pomp_comps summarizes the main arguments to the Pomp constructor and their correspondence to mathematical objects
...
Later section will demonstrate how how the JAX-based design enables further inference methods.
...
The particle filter algorithm, referred to Algorithm @alg:smc,
